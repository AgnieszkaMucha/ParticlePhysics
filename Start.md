...
FLUKA jest historycznym programem do projektowania osłon w reaktorach jądrowych, napisanym w języku fortran. Praca we Fluce odbywa się poprzez interfejs  Flair. Interfejs FLAIR ułatwia edycję plików wsadowych, uruchomienie kodu i wizualizację plików wynikowych. Napisany został w oparciu o standard Tkinter Pythona.
