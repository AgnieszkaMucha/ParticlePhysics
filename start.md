...
FLUKA jest historycznym programem do projektowania osłon w reaktorach jądrowych, napisanym w języku fortran. Praca we Fluce odbywa się poprzez bardzo wygodną architekturę Flair, w której importuje i uzupełnia się pliki wejściowe, przeprowadza symulację i wykonuje rozkłady.  
...
- Ze swojego konta na <it> taurusie </it> należy zalogować się na konto na serwerze <it> lhcb1 </it>.
