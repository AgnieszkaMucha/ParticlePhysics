...
- Rada ta sama, co w 3. Bardzo dobrym zwyczajem jest sprawdzanie po wykonaniu symulacji, czy Flair procesuje aktualne wyniki (np. patrząc na godzinę wykonania). Jeżeli błąd w symulacji, nie wykonała się, a w katalogu sa stare pliki, to Flair je dołączy.
